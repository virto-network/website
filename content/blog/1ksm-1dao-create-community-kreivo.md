...
description = "Creating a DAO is usually a not so straightforward process, until now. In this article, you'll learn how to create a community in Kreivo."
date = 2024-04-23
template = "post.html"
...
The first things you'll need to know before you create your Community (leaving the name and website
domain aside 😉) are:
...
> Here's an [example][extrinsics:example-7] of this call.
